...
def test_show_my_pets():
   ...
   #python -m pytest -v --driver Chrome --driver-path C:/Users/Konstantin/PycharmProjects/pythonProject7/driver/chromedriver.exe test_selenium_petfriends_elements.py